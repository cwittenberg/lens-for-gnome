...
/// Strategy Pattern: Encapsulates the complex Hybrid Search and File System mapping rules.
pub struct HybridSearchEngine;

impl HybridSearchEngine {
    pub fn search(
        conn_mutex: &Mutex<Connection>,
        cache_rwlock: &RwLock<HashMap<String, CachedDoc>>,
        ...
        if !ghosts_to_heal.is_empty() {
            ...
            let mut cache_write = cache_rwlock.write().unwrap();
            for ghost in ghosts_to_heal {
