...
export function checkDependencies() {
    ...
    let hasLibreOffice = GLib.find_program_in_path('libreoffice') !== null || GLib.find_program_in_path('soffice') !== null;

    return hasFfmpeg && hasGst && hasCogl && hasPdftocairo && hasLibreOffice;
}
...
export function getDistributionInstructions() {
    let instructions = {
        debian: "sudo apt install ffmpeg gir1.2-gstreamer-1.0 gir1.2-cogl-1.0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly gstreamer1.0-libav poppler-utils libreoffice",
        fedora: "sudo dnf install ffmpeg gstreamer1 gstreamer1-plugins-base gstreamer1-plugins-good gstreamer1-plugins-bad-free gstreamer1-plugins-ugly gstreamer1-plugin-libav poppler-utils libreoffice",
        arch: "sudo pacman -S ffmpeg gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly gst-libav poppler libreoffice-fresh",
        suse: "sudo zypper install ffmpeg typelib-1_0-Gst-1_0 gstreamer-plugins-base gstreamer-plugins-good gstreamer-plugins-bad gstreamer-plugins-ugly gstreamer-plugins-libav poppler-tools libreoffice",
        nixos: "nix-env -iA nixos.ffmpeg nixos.gst_all_1.gstreamer nixos.gst_all_1.gst-plugins-base nixos.gst_all_1.gst-plugins-good nixos.gst_all_1.gst-plugins-bad nixos.gst_all_1.gst-plugins-ugly nixos.gst_all_1.gst-libav nixos.poppler_utils nixos.libreoffice"
    };
