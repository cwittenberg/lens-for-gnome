...
export function checkDependencies() {
    ...
    // LibreOffice is an optional dependency for Office document previews.
    // It is no longer strictly required for the preview feature to activate.
    
    return hasFfmpeg && hasGst && hasPdftocairo;
}
